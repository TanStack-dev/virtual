...
Scrollt den Virtualizer zum Element des angegebenen Index. Optional können Sie einen Ausrichtungsmodus übergeben, um den Scroll an einem bestimmten Teil des ScrollElements zu verankern.
