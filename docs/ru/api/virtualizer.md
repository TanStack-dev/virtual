...
Прокручивает виртуализатор к элементу с указанным индексом. Можно дополнительно передать режим выравнивания, чтобы закрепить прокрутку к определённой части scrollElement.
